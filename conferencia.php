<?php include_once "includes/templates/header.php"; ?> 
    ...
    <section class="seccion contenedor">
        ...
        <p>
            Praesent rutrum efficitur pharetra. Vivamus scelersque pretium vellit, id tempor turpis pulvinar et. Ut
            bibendum
            finibus massa non molestie.
            curabitur urna metus, placerat gravida lacus ut, lacinia cangue orci. Maecenas luctus mi at ex blandit
            vehicula.
