            ...
            <div id="paquetes" class="paquetes">
                ...
                <div id="resumen" class="resumen">
                    ...
                    <div class="caja clearfix">
                        <div class="extras">
                            <div class="orden">
                                <label for="camisa-evento">camisa del evento $10.000 <small>(promocion 7% dto.)</small>
                                </label>
                                <input type="number" min="0" id="camisa_evento" size="3" placeholder="0">
                            </div> <!--  orden -->
                            <div class="orden">
                                <label for="camisa-evento">paquete de 10 etiquetas $2.000 <small>(HTML5, CSS3,
                                        JavaScript, Chrome)</small> </label>
                            ...
                            <div class="orden">
                                ...
                                <select id="regalo" required>
                                    ...
                                    <option value="PUL">Relog</option>
                                    <option value="PLU">Manillas</option>
